...
public class NNItemWritable implements Writable {
    ...
    public void add(int id, float[] vector, boolean flag_new, boolean flag_reverse, boolean flag_sample) {
    ...
    public void setVector(int id, float[] vector) {
        ...
        if(this.vector == null)
            this.vector = new float[dimVector];
